...
import style from './css/Content_Search.module.css'
            ...
            <div className={style.search_wrap}>
                <section className={style.search}>
                    <div className={style.search_left}>
                        ...
                        <p className={style.search}>어떻게보내야</p>
                        <p className={style.search}>잘보냈다고 소문이 날까?</p>
                    ...
                    <div className={style.search_right}>
                        <img src='./image/SearchContent/SearchContent1.png' alt=''/>
